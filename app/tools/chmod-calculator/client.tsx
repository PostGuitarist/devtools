  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          <Label>Command</Label>
          <div className="grid max-w-xl grid-cols-1 gap-3 sm:grid-cols-[1fr_auto_auto]">
            <Input
              value={target}
          ...
          <div className="border-input flex max-w-xl items-center justify-between gap-2 rounded-md border px-3 py-2">
